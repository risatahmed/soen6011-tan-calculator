...
\textbf{Public repository:} \url{https://github.com/risatahmed/soen6011-tan-calculator} (verified reachable from a logged-out session; Section~\ref{sec:repo}).
...
Public repository: \url{https://github.com/risatahmed/soen6011-tan-calculator} (created and pushed via \texttt{gh repo create}/\texttt{git push}; reachability confirmed with an unauthenticated \texttt{curl} request returning HTTP 200, equivalent to a logged-out browser visit).
